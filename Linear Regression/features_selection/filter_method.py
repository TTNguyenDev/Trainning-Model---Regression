...
names = ['MinTemp', 'MeanTemp', 'Snowfall', 'PoorWeather', 'YR', 'MO', 'DA', 'MAX', 'MIN', 'MEA', 'SNF', 'TSHDSBRSGF']
...
X_train = X_train[['MinTemp', 'MeanTemp', 'MAX', 'MIN', 'MEA']]
